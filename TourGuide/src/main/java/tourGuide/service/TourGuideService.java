...
public class TourGuideService {
    ...
    public List<Provider> getTripDeals(User user) {
        ...
        List<Provider> providers = tripPricer.getPrice(tripPricerApiKey, String.valueOf(user.getUserId()), user.getUserPreferences().getNumberOfAdults(),
                user.getUserPreferences().getNumberOfChildren(),
                user.getUserPreferences().getTripDuration(), cumulatativeRewardPoints).getBody();
